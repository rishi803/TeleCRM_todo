  ...
  return (
    <div className="todo-container">
      ...
      <div className="filter-container">
        ...
        <button onClick={() => setFilter("completed")} className={`completed ${filter === "completed" ? "active" : ""}`}>
          Completed
        </button>
        <button onClick={() => setFilter("pending")} className={`pending ${filter === "pending" ? "active" : ""}`}>
          Pending
        </button>
      </div>
